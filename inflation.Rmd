...
inflation %>% 
  ...
  NULL
```
This is **hello**, while this is *sunshine*.
...
usethis::use_git_config(
  user.name = "Denise Kohlhepp", # <-- change to your name
  user.email = "kohlhepp.denise@gmail.com", # <-- and your email
